...
@section('content')
    ...
    <section class="anime">
        <div class="container">
            ...
            <h1 class="pb-3 border-bottom text-end mt-5">Sélection d'Anime...</h1>

            <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5" style="overflow-y: hidden; overflow-x: scroll">

                @foreach($response as $anime)
                    <div class="col">
                        <div class="card card-cover h-100 p-4 overflow-hidden text-white bg-dark rounded-3 shadow" style="background-image: url({{ $anime['attributes']['posterImage']['medium']}}); background-position: center center; background-repeat: no-repeat; background-size: cover">
